...
function App() {
	...
	return (
		<>
			{/* Background gradient */}
			<div className="absolute -z-10 h-full w-full bg-conic/decreasing from-pink-300 via-amber-200 to-cyan-800 blur-3xl" />

			{/* Content and black layer */}
			<div className="fixed flex flex-col items-center justify-center h-dvh w-dvw space-y-5 md:space-y-10 overflow-hidden bg-black/15">
				...
				<div className="relative w-54 h-54 mb-4">
					...
					<div className="absolute inset-0 animate-spin-slow">
						...
						>
							...
							<text className="fill-deepText text-[13px] tracking-widest uppercase font-light">
